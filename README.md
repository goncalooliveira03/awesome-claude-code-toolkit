...
| [claude-discord-presence](https://github.com/goncalooliveira03/claude-discord-presence) | - | Discord Rich Presence for Claude Code on Windows. Shows the session's repo, branch, current activity and model. Async hooks, background daemon, zero dependencies. MIT |
