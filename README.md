...
| [presence-for-claude](https://github.com/goncalooliveira03/presence-for-claude) | - | Discord Rich Presence for Claude Code on Windows. Shows the session's repo, branch, current activity and model. Async hooks, background daemon, zero dependencies. MIT |
